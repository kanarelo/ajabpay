...
INSERT INTO `alembic_version` VALUES ('562eae7d587e');
...
CREATE TABLE `configledgeraccount` (
  ...
  `balance_direction` int(11) DEFAULT NULL,
  `date_created` date DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`),
...
INSERT INTO `configledgeraccount` VALUES (1,'Assets','10000000',1,NULL,'2016-09-15'),(2,'Cash at Bank','11000000',1,NULL,'2016-09-15'),(3,'Prepayments and Sundry receivables','12000000',1,NULL,'2016-09-15'),(4,'Financial Investments','13000000',1,NULL,'2016-09-15'),(5,'Net Loan Portfolio','14000000',1,NULL,'2016-09-15'),(6,'Accounts Receivable','15000000',1,NULL,'2016-09-15'),(7,'Liabilities','20000000',2,NULL,'2016-09-15'),(8,'Members Savings Deposits','21000000',2,NULL,'2016-09-15'),(9,'Accounts Payables & Other Liabilities','22000000',2,NULL,'2016-09-15'),(10,'Equity','30000000',3,NULL,'2016-09-15'),(11,'Share Capital','31000000',3,NULL,'2016-09-15'),(12,'Grants and Donations','32000000',3,NULL,'2016-09-15'),(13,'Retained Earnings','33000000',3,NULL,'2016-09-08'),(14,'Income','40000000',4,NULL,'2016-09-15'),(15,'Financial Income','41000000',4,NULL,'2016-09-15'),(16,'Interest Income','41100000',4,NULL,'2016-09-15'),(17,'Fee Income','41200000',4,NULL,'2016-09-15'),(18,'Penalty Income','41300000',4,NULL,'2016-09-15'),(19,'Expenses','50000000',5,NULL,'2016-09-15'),(20,'Financial Expense','51000000',5,NULL,'2016-09-15'),(21,'Write-Off Expense','51200000',5,NULL,'2016-09-15'),(22,'Interest Expense','51300000',5,NULL,'2016-09-15');
...
INSERT INTO `configproducttype` VALUES (1,'Paypal to Mpesa','PP-MPESA'),(2,'Mpesa to Paypal','MPESA-PP');
...
INSERT INTO `configtransactiontype` VALUES (1,'Paypal to Mpesa Exchange','PP-MPESA-FX'),(2,'Mpesa to Paypal Exchange','MPESA-PP-FX');
...
CREATE TABLE `product` (
  ...
  CONSTRAINT `product_ibfk_1` FOREIGN KEY (`amount_currency_id`) REFERENCES `configcurrency` (`id`),
...
CREATE TABLE `transaction` (
  ...
  CONSTRAINT `transaction_ibfk_4` FOREIGN KEY (`status_id`) REFERENCES `configtransactionstatus` (`id`),
...
CREATE TABLE `transactionstatus` (
  ...
  `transaction_id` int(11) DEFAULT NULL,
  `status_id` int(11) DEFAULT NULL,
  `transaction_status_date` date DEFAULT NULL,
...
INSERT INTO `user` VALUES (1,'Onesmus','Mukewa','onesmus.mukewa@gmail.com','mkemonda','703266966',NULL,NULL);
...
-- Dump completed on 2016-09-16 13:37:27
